...
import { Mail, Lock, Eye, EyeOff, AlertCircle, Shield, LogIn } from 'lucide-react';
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <Mail className={`absolute left-3 top-3.5 h-4 w-4 transition-colors duration-200 ${
              isFormFocused ? 'text-blue-500' : 'text-muted-foreground'
            }`} />
            <Input
              id="login-email"
              type="email"
              ...
              className={`pl-10 h-12 transition-all duration-200 ${
                emailError ? 'border-red-500 focus:border-red-500' : 'focus:border-blue-500 hover:border-blue-300'
              }`}
              required
          ...
          <div className="relative group">
            ...
            <Input
              ...
              className={`pl-10 pr-12 h-12 transition-all duration-200 ${
                passwordError ? 'border-red-500 focus:border-red-500' : 'focus:border-blue-500 hover:border-blue-300'
              }`}
              required
              disabled={isSubmitting}
            />
