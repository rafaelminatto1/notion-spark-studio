    ...
    try {
      if (documentId?.startsWith('new')) {
        ...
        const existingDoc: Document = {
          id: documentId,
          title: 'Projeto Notion Spark Studio - Colaboração',
          content: `# 🚀 Bem-vindo ao Notion Spark Studio

Este é um exemplo de documento rico com **colaboração em tempo real**!

## ✨ Funcionalidades de Colaboração

- 💬 **Comentários em tempo real** - Selecione texto e adicione comentários
- 👥 **Presença de usuários** - Veja quem está online
- 🎯 **Cursors colaborativos** - Veja onde outros estão editando
- 💭 **Chat integrado** - Converse durante a edição
- 🔄 **Sincronização automática** - Mudanças em tempo real

## 🎯 Como usar

1. **Comentários**: Selecione qualquer texto e clique no ícone de comentários
2. **Chat**: Use o painel lateral para conversar com a equipe
3. **Presença**: Veja os avatares dos usuários online no topo
4. **Edição**: Digite normalmente - tudo é sincronizado automaticamente

## 👥 Usuários Online

Você pode ver outros usuários editando este documento em tempo real. Seus cursors aparecerão em cores diferentes!

---

**💡 Dica**: Este sistema simula colaboração real. Em produção, seria conectado ao Supabase Realtime para sincronização verdadeira entre usuários.`,
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  className={showCommentsPanel ? 'bg-blue-50 border-blue-200' : ''}
                >
                ...
                <Button
                  ...
                  className={showChatPanel ? 'bg-blue-50 border-blue-200' : ''}
                >
